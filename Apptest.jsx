...
import { Home, Users, Package, Phone, Mail, MapPin, Clock, Search, Filter, Settings, Plus, Edit, Trash2, Download, Upload, Eye, EyeOff, Lock, User, Coffee, Wine, Beer, ShoppingCart, Star, Menu, X, CheckCircle, AlertCircle, Key, Instagram, Facebook, ChevronRight, Sparkles, Crown, Zap, Shield, Truck, Award } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3 bg-gold/10 border border-gold/20 rounded-full px-6 py-3">
                ...
                <span className="text-gold-light text-sm font-medium">Excelência em Bebidas Premium</span>
              </div>
              
              <h1 className="text-6xl lg:text-7xl font-bold leading-tight">
                Descubra o 
                <span className="bg-gradient-to-r from-gold to-gold-light bg-clip-text text-transparent block">Mundo das</span>
                Bebidas Finas
              </h1>
              
              <p className="text-xl text-gray-300 leading-relaxed max-w-2xl">
                Na Chalene Bebidas, cada garrafa conta uma história. Descubra sabores únicos e experiências 
                memoráveis com nossa seleção premium cuidadosamente curada.
              </p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-4">
                      <div className="bg-card-dark rounded-2xl p-6 hover-glow transition-all duration-300">
                        ...
                        <p className="text-gray-400 text-sm">Das melhores vinícolas do mundo</p>
                      </div>
                      <div className="bg-card-dark rounded-2xl p-6 hover-glow transition-all duration-300">
                        <Beer className="text-gold mb-3" size={32} />
                        <h3 className="font-bold text-white mb-2">Cervejas Artesanais</h3>
                        <p className="text-gray-400 text-sm">Sabores únicos e exclusivos</p>
                      </div>
                    </div>
                    <div className="space-y-4 mt-8">
                      <div className="bg-card-dark rounded-2xl p-6 hover-glow transition-all duration-300">
                        <Coffee className="text-gold mb-3" size={32} />
                        <h3 className="font-bold text-white mb-2">Cafés Premium</h3>
                        <p className="text-gray-400 text-sm">Grãos selecionados a mão</p>
                      </div>
                      <div className="bg-card-dark rounded-2xl p-6 hover-glow transition-all duration-300">
                        <Crown className="text-gold mb-3" size={32} />
                        <h3 className="font-bold text-white mb-2">Destilados Exclusivos</h3>
                        <p className="text-gray-400 text-sm">Para os verdadeiros apreciadores</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="bg-glass rounded-3xl p-8 backdrop-blur-xl">
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-12 h-12 bg-gold-gradient rounded-2xl flex items-center justify-center hover:scale-110 transition-transform">
            ...
            <div className="bg-glass rounded-3xl p-8 backdrop-blur-xl">
              ...
              <div className="bg-black/30 border-2 border-gold/20 rounded-2xl w-full h-96 flex items-center justify-center flex-col">
                <MapPin className="text-gold mb-4" size={64} />
                <span className="text-gold-light font-semibold text-lg">Foz do Iguaçu - PR</span>
                <p className="text-gray-400 mt-2 text-center">{companyInfo.address}</p>
              </div>
            </div>
          </div>
        </div>
